...
df <- read_csv("https://assets.publishing.service.gov.uk/media/691ded56d140bbbaa59a2a7d/File_7_IoD2025_All_Ranks_Scores_Deciles_Population_Denominators.csv") %>%
  ...
  select(lsoa21cd = "lsoa_code_2021", score = "barriers_to_housing_and_services_score", population = "total_population_mid_2022") %>% 
  mutate(indicator="Indices of Deprivation: Barriers to Housing and Services")
...
write_csv (iod_ward, "../data/housing_deprivation.csv")
