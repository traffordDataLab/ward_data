...
df <- read_csv("https://assets.publishing.service.gov.uk/media/691ded56d140bbbaa59a2a7d/File_7_IoD2025_All_Ranks_Scores_Deciles_Population_Denominators.csv") %>%
  ...
  select(lsoa21cd = "lsoa_code_2021", score = "income_deprivation_affecting_children_index_idaci_score_rate", population = "dependent_children_aged_0_15_mid_2022") %>% 
...
write_csv (iod_ward, "../data/income_deprivation_children.csv")
