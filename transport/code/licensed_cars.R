...
df <- read_csv("https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1090507/df_VEH0125.csv") %>%
  clean_names()
# LSOA to ward lookup #
